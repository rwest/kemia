 ...
 * dialogs that are smarter about interacting with a reaction editor.
 *
 */

goog.provide('kemia.controller.plugins.AbstractDialog');
goog.provide('kemia.controller.plugins.AbstractDialog.Builder');
goog.provide('kemia.controller.plugins.AbstractDialog.EventType');
 ...
 */
kemia.controller.plugins.AbstractDialog = function(domHelper) {
  goog.events.EventTarget.call(this);
  this.dom = domHelper;
};
goog.inherits(kemia.controller.plugins.AbstractDialog, goog.events.EventTarget);
 ...
 * dialog if needed.
 */
kemia.controller.plugins.AbstractDialog.prototype.show = function() {
 ...
 */
kemia.controller.plugins.AbstractDialog.prototype.hide = function() {
  if (this.dialogInternal_) {
 ...
 */
kemia.controller.plugins.AbstractDialog.prototype.isOpen = function() {
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.processOkAndClose = function() {
 ...
 * @enum {string}
 */
kemia.controller.plugins.AbstractDialog.EventType = {
 ...
 * @param {kemia.controller.plugins.AbstractDialog} editorDialog Editor dialog object
 *     that will wrap the wrapped dialog object this builder will create.
 * @constructor
 */
kemia.controller.plugins.AbstractDialog.Builder = function(editorDialog) {
 ...
 * @return {kemia.controller.plugins.AbstractDialog.Builder} This.
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.setTitle = function(title) {
 ...
 * @return {kemia.controller.plugins.AbstractDialog.Builder} This.
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.addOkButton =
    function(opt_label) {
 ...
 * @return {kemia.controller.plugins.AbstractDialog.Builder} This.
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.addCancelButton =
    function(opt_label) {
 ...
 * @return {kemia.controller.plugins.AbstractDialog.Builder} This.
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.addButton =
 ...
 * @return {kemia.controller.plugins.AbstractDialog.Builder} This.
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.addClassName =
    function(className) {
 ...
 * @return {kemia.controller.plugins.AbstractDialog.Builder} This.
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.setContent =
 ...
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.build = function() {
 ...
 * @type {kemia.controller.plugins.AbstractDialog}
 * @private
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.editorDialog_;
 ...
 * @private
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.wrappedDialog_;
 ...
 * @private
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.buttonSet_;
 ...
 * @private
 */
kemia.controller.plugins.AbstractDialog.Builder.prototype.buttonHandlers_;
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.dom;
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.createDialogControl =
    goog.abstractMethod;
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.getOkButtonElement = function() {
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.getCancelButtonElement = function() {
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.getButtonElement = function(buttonId) {
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.createOkEvent = goog.abstractMethod;
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.handleOk = function(e) {
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.handleCancel = function() {
  this.dispatchEvent(kemia.controller.plugins.AbstractDialog.EventType.CANCEL);
};
 ...
 * @protected
 */
kemia.controller.plugins.AbstractDialog.prototype.disposeInternal = function() {
  if (this.dialogInternal_) {
    this.hide();
  ...
  kemia.controller.plugins.AbstractDialog.superClass_.disposeInternal.call(this);
};
 ...
 * @private
 */
kemia.controller.plugins.AbstractDialog.prototype.dialogInternal_;
 ...
 * @private
 */
kemia.controller.plugins.AbstractDialog.prototype.handleAfterHide_ = function() {
  this.dispatchEvent(kemia.controller.plugins.AbstractDialog.EventType.AFTER_HIDE);
};
